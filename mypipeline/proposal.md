...
3. **Discord handle:** *(add your Discord handle from the foss42 server)*
4. **Home page:** https://api-explorer-web.vercel.app/
6. **GitHub:** https://github.com/bhumikanilesh
7. **LinkedIn / other socials:** *(add your LinkedIn URL)*
8. **Time zone:** IST (UTC+5:30)
9. **Resume:** *(add a publicly accessible PDF link — Google Drive with "anyone with link can view", or similar)*
...
![All tests passing](images/tests_passing.png)
